---
name: argus-explore
description: AI exploration mode — Claude maps an app with Argus cloud browsers, discovers user journeys, saves them as replayable flows, and audits UI/UX. Use when asked to "explore and test" an app, generate a test suite for a URL, or verify software end-to-end with Argus.
---
